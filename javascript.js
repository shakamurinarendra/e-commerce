function myFunction() {
    ...
    var setUpLinks = ['Shoes/Lite racer 2.0 shoes', 'Shoes/Nemeziz 19.3 boots', 'Shoes/Solecourt shoes', 'Shoes/Marathon tech shoes',
                        ...
                        'Clothes/adidas Z.N.E. full-zip hoodie', 'Clothes/AEROREADY 3-stripes pants', 'Clothes/Alphaskin sport short tights', 'Clothes/Climacool polo shirt',
                        ...
                        'Accessories/Adicross ball case', 'Accessories/adidas athletics pack dad cap', 'Accessories/AEROREADY visor', 'Accessories/Classic boxy backpack',
    ...
    var setUpImgs = ['Lite_Racer_2.0_Shoes_Black_EG9831_01_standard', 
                        ...
                        'adidas_Z.N.E._Full-Zip_Hoodie_Black_GM6531_01_laydown',
    ...
    var setUpContents = ['LITE RACER 2.0 SHOES', 'NEMEZIZ 19.3 FIRM GROUND BOOTS', 'SOLECOURT SHOES', 'MARATHON TECH SHOES', 
                        ...
                        'ADIDAS Z.N.E FULL-ZIP HOODIE', 'AEROREADY 3-STRIPES PANTS' , 'ALPHASKIN SPORT SHORT TIGHTS' , 'CLIMACOOL POLO SHIRT',
